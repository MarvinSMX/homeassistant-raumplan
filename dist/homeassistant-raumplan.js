 ...
 */null===(ft=window.HTMLSlotElement)||void 0===ft||ft.prototype.assignedElements;var _t,yt;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(_t||(_t={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(yt||(yt={}));function bt(t){return t.substr(0,t.indexOf("."))}var $t=["closed","locked","off"],xt=(new Set(["fan","input_boolean","light","switch","group","automation"]),function(t,e,i,n){n=n||{},i=null==i?{}:i;var o=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return o.detail=i,t.dispatchEvent(o),o});new Set(["call-service","divider","section","weblink","cast","select"]);var wt=function(t){xt(window,"haptic",t)},kt=function(t,e,i){void 0===i&&(i=!1),i?history.replaceState(null,"",e):history.pushState(null,"",e),xt(window,"location-changed",{replace:i})},At=function(t,e){return function(t,e,i){void 0===i&&(i=!0);var n,o=bt(e),a="group"===o?"homeassistant":o;switch(o){case"lock":n=i?"unlock":"lock";break;case"cover":n=i?"open_cover":"close_cover";break;default:n=i?"turn_on":"turn_off"}return t.callService(a,n,{entity_id:e})}(t,e,$t.includes(t.states[e].state))},Et=function(t,e,i,n){var o;"double_tap"===n&&i.double_tap_action?o=i.double_tap_action:"hold"===n&&i.hold_action?o=i.hold_action:"tap"===n&&i.tap_action&&(o=i.tap_action),function(t,e,i,n){if(n||(n={action:"more-info"}),!n.confirmation||n.confirmation.exemptions&&n.confirmation.exemptions.some(function(t){return t.user===e.user.id})||(wt("warning"),confirm(n.confirmation.text||"Are you sure you want to "+n.action+"?")))switch(n.action){case"more-info":(i.entity||i.camera_image)&&xt(t,"hass-more-info",{entityId:i.entity?i.entity:i.camera_image});break;case"navigate":n.navigation_path&&kt(0,n.navigation_path);break;case"url":n.url_path&&window.open(n.url_path);break;case"toggle":i.entity&&(At(e,i.entity),wt("success"));break;case"call-service":if(!n.service)return void wt("failure");var o=n.service.split(".",2);e.callService(o[0],o[1],n.service_data,n.target),wt("success");break;case"fire-dom-event":xt(t,"ll-custom",n)}}(t,e,i,o)};function St(t){return void 0!==t&&"none"!==t.action}const Ct=JSON.parse('{"common":{"version":"Version","invalid_configuration":"Ungültige Konfiguration","show_warning":"Warnung anzeigen","configure":"Bitte konfigurieren: Bild-URL und Entitäten mit Koordinaten."}}');var Mt=o.t(Ct,2);const zt=JSON.parse('{"common":{"version":"Version","invalid_configuration":"Invalid configuration","show_warning":"Show warning","configure":"Please configure: image URL and entities with coordinates."}}');const Nt={de:Mt,en:o.t(zt,2)};function Pt(t,e){return t?.states?.[e]?.attributes?.friendly_name||e}class Ht{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const Tt="ontouchstart"in window||navigator.maxTouchPoints>0;class Ot extends HTMLElement{constructor(){super(...arguments),this.holdTime=500,this.held=!1}connectedCallback(){Object.assign(this.style,{position:"absolute",width:Tt?"100px":"50px",height:Tt?"100px":"50px",transform:"translate(-50%, -50%)",pointerEvents:"none",zIndex:"999"})}bind(t,e){if(t._roomPlanActionHandler)return;t._roomPlanActionHandler=!0,t.addEventListener("contextmenu",t=>(t.preventDefault(),t.stopPropagation(),!1));const i=()=>{this.held=!1,this.timer=window.setTimeout(()=>{this.held=!0},this.holdTime)},n=i=>{if(!["touchend","touchcancel"].includes(i.type)||void 0!==this.timer)if(i.preventDefault(),clearTimeout(this.timer),this.timer=void 0,this.held)xt(t,"action",{action:"hold"});else if(e.hasDoubleClick){const e=i;"click"===i.type&&e.detail<2||!this.dblClickTimeout?this.dblClickTimeout=window.setTimeout(()=>{this.dblClickTimeout=void 0,xt(t,"action",{action:"tap"})},250):(clearTimeout(this.dblClickTimeout),this.dblClickTimeout=void 0,xt(t,"action",{action:"double_tap"}))}else xt(t,"action",{action:"tap"})},o=()=>{clearTimeout(this.timer),this.timer=void 0};["touchcancel","mouseout","mouseup","touchmove","mouseleave"].forEach(e=>{t.addEventListener(e,o,{passive:!0})}),t.addEventListener("touchstart",i,{passive:!0}),t.addEventListener("touchend",n),t.addEventListener("touchcancel",n),t.addEventListener("mousedown",i,{passive:!0}),t.addEventListener("click",n),t.addEventListener("keyup",t=>{"Enter"!==t.key&&13!==t.keyCode||n(t)})}}customElements.define("action-handler-room-plan",Ot);const Ut=(t,e)=>{(()=>{let t=document.body.querySelector("action-handler-room-plan");return t||(t=document.createElement("action-handler-room-plan"),document.body.appendChild(t)),t})().bind(t,e??{})},Rt=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends Ht{update(t,[e]){return Ut(t.element,e),W}render(t){return W}});var Lt=function(t,e,i,n){var o,a=arguments.length,r=a<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)r=Reflect.decorate(t,e,i,n);else for(var s=t.length-1;s>=0;s--)(o=t[s])&&(r=(a<3?o(r):a>3?o(e,i,r):o(e,i))||r);return a>3&&r&&Object.defineProperty(e,i,r),r};let jt=class extends ht{constructor(){super(...arguments),this._config={type:"",image:"",entities:[]}}setConfig(t){const e=t??{type:"",image:"",entities:[]},i="string"==typeof e.image?e.image:e.image?.location??"";this._config={...e,image:i,entities:Array.isArray(e.entities)?[...e.entities]:[],entity_filter:Array.isArray(e.entity_filter)?e.entity_filter:void 0,temperature_zones:Array.isArray(e.temperature_zones)?[...e.temperature_zones]:void 0,alert_entities:Array.isArray(e.alert_entities)?e.alert_entities:void 0,alert_badge_action:e.alert_badge_action,image_dark:e.image_dark,dark_mode_filter:e.dark_mode_filter,dark_mode:e.dark_mode}}_emitConfig(){xt(this,"config-changed",{config:this._config})}_updateConfig(t){this._config={...this._config,...t},this._emitConfig()}_updateEntity(t,e){const i=[...this._config.entities??[]];i[t]={...i[t],...e},this._updateConfig({entities:i})}_removeEntity(t){const e=[...this._config.entities??[]];e.splice(t,1),this._updateConfig({entities:e})}_addEntity(){const t=[...this._config.entities??[],{entity:"",x:50,y:50}];this._updateConfig({entities:t})}_updateHeatmapZone(t,e){const i=[...this._config.temperature_zones??[]];i[t]={...i[t],...e},this._updateConfig({temperature_zones:i})}_removeHeatmapZone(t){const e=[...this._config.temperature_zones??[]];e.splice(t,1),this._updateConfig({temperature_zones:e.length?e:void 0})}_addHeatmapZone(){const t=[...this._config.temperature_zones??[],{entity:"",x1:10,y1:10,x2:40,y2:40}];this._updateConfig({temperature_zones:t})}_updateAlertEntity(t,e){const i=[...this._config.alert_entities??[]];i[t]=e.trim(),this._updateConfig({alert_entities:i})}_removeAlertEntity(t){const e=[...this._config.alert_entities??[]];e.splice(t,1),this._updateConfig({alert_entities:e.length?e:void 0})}_addAlertEntity(){const t=[...this._config.alert_entities??[],""];this._updateConfig({alert_entities:t})}render(){const t="string"==typeof this._config.image?this._config.image:"",e=this._config.title??"",i=Number(this._config.rotation)??0,n=this._config.entities??[],o=this.hass?.states?Object.keys(this.hass.states).sort():[];return V`
    ...
    `}};Dt([gt({attribute:!1})],Ft.prototype,"hass",void 0),Dt([vt()],Ft.prototype,"config",void 0),Dt([vt()],Ft.prototype,"_imageLoaded",void 0),Dt([vt()],Ft.prototype,"_imageError",void 0),Dt([vt()],Ft.prototype,"_imageAspect",void 0),Dt([vt()],Ft.prototype,"_activeFilter",void 0),Dt([vt()],Ft.prototype,"_darkMode",void 0),Ft=Dt([ut(Bt)],Ft),console.info("%c RAUMPLAN v1.0.0","color: #03a9f4; font-weight: bold");export{Ft as RoomPlanCard};