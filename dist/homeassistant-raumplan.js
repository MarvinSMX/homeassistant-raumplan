 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var w;x[$]=!0,x.elementProperties=new Map,x.elementStyles=[],x.shadowRootOptions={mode:"open"},null==f||f({ReactiveElement:x}),(null!==(u=m.reactiveElementVersions)&&void 0!==u?u:m.reactiveElementVersions=[]).push("1.6.3");const A=window,E=A.trustedTypes,S=E?E.createPolicy("lit-html",{createHTML:t=>t}):void 0,k="$lit$",C=`lit$${(Math.random()+"").slice(9)}$`,P="?"+C,O=`<${P}>`,z=document,T=()=>z.createComment(""),U=t=>null===t||"object"!=typeof t&&"function"!=typeof t,N=Array.isArray,M=t=>N(t)||"function"==typeof(null==t?void 0:t[Symbol.iterator]),H="[ \t\n\f\r]",R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,L=/-->/g,j=/>/g,D=RegExp(`>|${H}(?:([^\\s"'>=/]+)(${H}*=${H}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),I=/'/g,B=/"/g,F=/^(?:script|style|textarea|title)$/i,V=t=>(e,...i)=>({_$litType$:t,strings:e,values:i}),K=V(1),W=(V(2),Symbol.for("lit-noChange")),q=Symbol.for("lit-nothing"),J=new WeakMap,X=z.createTreeWalker(z,129,null,!1);function Y(t,e){if(!Array.isArray(t)||!t.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==S?S.createHTML(e):e}const Z=(t,e)=>{const i=t.length-1,n=[];let o,r=2===e?"<svg>":"",s=R;for(let e=0;e<i;e++){const i=t[e];let a,l,c=-1,d=0;for(;d<i.length&&(s.lastIndex=d,l=s.exec(i),null!==l);)d=s.lastIndex,s===R?"!--"===l[1]?s=L:void 0!==l[1]?s=j:void 0!==l[2]?(F.test(l[2])&&(o=RegExp("</"+l[2],"g")),s=D):void 0!==l[3]&&(s=D):s===D?">"===l[0]?(s=null!=o?o:R,c=-1):void 0===l[1]?c=-2:(c=s.lastIndex-l[2].length,a=l[1],s=void 0===l[3]?D:'"'===l[3]?B:I):s===B||s===I?s=D:s===L||s===j?s=R:(s=D,o=void 0);const h=s===D&&t[e+1].startsWith("/>")?" ":"";r+=s===R?i+O:c>=0?(n.push(a),i.slice(0,c)+k+i.slice(c)+C+h):i+C+(-2===c?(n.push(void 0),e):h)}return[Y(t,r+(t[i]||"<?>")+(2===e?"</svg>":"")),n]};class G{constructor({strings:t,_$litType$:e},i){let n;this.parts=[];let o=0,r=0;const s=t.length-1,a=this.parts,[l,c]=Z(t,e);if(this.el=G.createElement(l,i),X.currentNode=this.el.content,2===e){const t=this.el.content,e=t.firstChild;e.remove(),t.append(...e.childNodes)}for(;null!==(n=X.nextNode())&&a.length<s;){if(1===n.nodeType){if(n.hasAttributes()){const t=[];for(const e of n.getAttributeNames())if(e.endsWith(k)||e.startsWith(C)){const i=c[r++];if(t.push(e),void 0!==i){const t=n.getAttribute(i.toLowerCase()+k).split(C),e=/([.?@])?(.*)/.exec(i);a.push({type:1,index:o,name:e[2],strings:t,ctor:"."===e[1]?nt:"?"===e[1]?rt:"@"===e[1]?st:it})}else a.push({type:6,index:o})}for(const e of t)n.removeAttribute(e)}if(F.test(n.tagName)){const t=n.textContent.split(C),e=t.length-1;if(e>0){n.textContent=E?E.emptyScript:"";for(let i=0;i<e;i++)n.append(t[i],T()),X.nextNode(),a.push({type:2,index:++o});n.append(t[e],T())}}}else if(8===n.nodeType)if(n.data===P)a.push({type:2,index:o});else{let t=-1;for(;-1!==(t=n.data.indexOf(C,t+1));)a.push({type:7,index:o}),t+=C.length-1}o++}}static createElement(t,e){const i=z.createElement("template");return i.innerHTML=t,i}}function Q(t,e,i=t,n){var o,r,s,a;if(e===W)return e;let l=void 0!==n?null===(o=i._$Co)||void 0===o?void 0:o[n]:i._$Cl;const c=U(e)?void 0:e._$litDirective$;return(null==l?void 0:l.constructor)!==c&&(null===(r=null==l?void 0:l._$AO)||void 0===r||r.call(l,!1),void 0===c?l=void 0:(l=new c(t),l._$AT(t,i,n)),void 0!==n?(null!==(s=(a=i)._$Co)&&void 0!==s?s:a._$Co=[])[n]=l:i._$Cl=l),void 0!==l&&(e=Q(t,l._$AS(t,e.values),l,n)),e}class tt{constructor(t,e){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=e}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){var e;const{el:{content:i},parts:n}=this._$AD,o=(null!==(e=null==t?void 0:t.creationScope)&&void 0!==e?e:z).importNode(i,!0);X.currentNode=o;let r=X.nextNode(),s=0,a=0,l=n[0];for(;void 0!==l;){if(s===l.index){let e;2===l.type?e=new et(r,r.nextSibling,this,t):1===l.type?e=new l.ctor(r,l.name,l.strings,this,t):6===l.type&&(e=new at(r,this,t)),this._$AV.push(e),l=n[++a]}s!==(null==l?void 0:l.index)&&(r=X.nextNode(),s++)}return X.currentNode=z,o}v(t){let e=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(t,i,e),e+=i.strings.length-2):i._$AI(t[e])),e++}}class et{constructor(t,e,i,n){var o;this.type=2,this._$AH=q,this._$AN=void 0,this._$AA=t,this._$AB=e,this._$AM=i,this.options=n,this._$Cp=null===(o=null==n?void 0:n.isConnected)||void 0===o||o}get _$AU(){var t,e;return null!==(e=null===(t=this._$AM)||void 0===t?void 0:t._$AU)&&void 0!==e?e:this._$Cp}get parentNode(){let t=this._$AA.parentNode;const e=this._$AM;return void 0!==e&&11===(null==t?void 0:t.nodeType)&&(t=e.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,e=this){t=Q(this,t,e),U(t)?t===q||null==t||""===t?(this._$AH!==q&&this._$AR(),this._$AH=q):t!==this._$AH&&t!==W&&this._(t):void 0!==t._$litType$?this.g(t):void 0!==t.nodeType?this.$(t):M(t)?this.T(t):this._(t)}k(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}$(t){this._$AH!==t&&(this._$AR(),this._$AH=this.k(t))}_(t){this._$AH!==q&&U(this._$AH)?this._$AA.nextSibling.data=t:this.$(z.createTextNode(t)),this._$AH=t}g(t){var e;const{values:i,_$litType$:n}=t,o="number"==typeof n?this._$AC(t):(void 0===n.el&&(n.el=G.createElement(Y(n.h,n.h[0]),this.options)),n);if((null===(e=this._$AH)||void 0===e?void 0:e._$AD)===o)this._$AH.v(i);else{const t=new tt(o,this),e=t.u(this.options);t.v(i),this.$(e),this._$AH=t}}_$AC(t){let e=J.get(t.strings);return void 0===e&&J.set(t.strings,e=new G(t)),e}T(t){N(this._$AH)||(this._$AH=[],this._$AR());const e=this._$AH;let i,n=0;for(const o of t)n===e.length?e.push(i=new et(this.k(T()),this.k(T()),this,this.options)):i=e[n],i._$AI(o),n++;n<e.length&&(this._$AR(i&&i._$AB.nextSibling,n),e.length=n)}_$AR(t=this._$AA.nextSibling,e){var i;for(null===(i=this._$AP)||void 0===i||i.call(this,!1,!0,e);t&&t!==this._$AB;){const e=t.nextSibling;t.remove(),t=e}}setConnected(t){var e;void 0===this._$AM&&(this._$Cp=t,null===(e=this._$AP)||void 0===e||e.call(this,t))}}class it{constructor(t,e,i,n,o){this.type=1,this._$AH=q,this._$AN=void 0,this.element=t,this.name=e,this._$AM=n,this.options=o,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=q}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(t,e=this,i,n){const o=this.strings;let r=!1;if(void 0===o)t=Q(this,t,e,0),r=!U(t)||t!==this._$AH&&t!==W,r&&(this._$AH=t);else{const n=t;let s,a;for(t=o[0],s=0;s<o.length-1;s++)a=Q(this,n[i+s],e,s),a===W&&(a=this._$AH[s]),r||(r=!U(a)||a!==this._$AH[s]),a===q?t=q:t!==q&&(t+=(null!=a?a:"")+o[s+1]),this._$AH[s]=a}r&&!n&&this.j(t)}j(t){t===q?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=t?t:"")}}class nt extends it{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===q?void 0:t}}const ot=E?E.emptyScript:"";class rt extends it{constructor(){super(...arguments),this.type=4}j(t){t&&t!==q?this.element.setAttribute(this.name,ot):this.element.removeAttribute(this.name)}}class st extends it{constructor(t,e,i,n,o){super(t,e,i,n,o),this.type=5}_$AI(t,e=this){var i;if((t=null!==(i=Q(this,t,e,0))&&void 0!==i?i:q)===W)return;const n=this._$AH,o=t===q&&n!==q||t.capture!==n.capture||t.once!==n.once||t.passive!==n.passive,r=t!==q&&(n===q||o);o&&this.element.removeEventListener(this.name,this,n),r&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){var e,i;"function"==typeof this._$AH?this._$AH.call(null!==(i=null===(e=this.options)||void 0===e?void 0:e.host)&&void 0!==i?i:this.element,t):this._$AH.handleEvent(t)}}class at{constructor(t,e,i){this.element=t,this.type=6,this._$AN=void 0,this._$AM=e,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(t){Q(this,t)}}const lt=A.litHtmlPolyfillSupport;null==lt||lt(G,et),(null!==(w=A.litHtmlVersions)&&void 0!==w?w:A.litHtmlVersions=[]).push("2.8.0");var ct,dt;
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class ht extends x{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var t,e;const i=super.createRenderRoot();return null!==(t=(e=this.renderOptions).renderBefore)&&void 0!==t||(e.renderBefore=i.firstChild),i}update(t){const e=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(t),this._$Do=((t,e,i)=>{var n,o;const r=null!==(n=null==i?void 0:i.renderBefore)&&void 0!==n?n:e;let s=r._$litPart$;if(void 0===s){const t=null!==(o=null==i?void 0:i.renderBefore)&&void 0!==o?o:null;r._$litPart$=s=new et(e.insertBefore(T(),t),t,void 0,null!=i?i:{})}return s._$AI(t),s})(e,this.renderRoot,this.renderOptions)}connectedCallback(){var t;super.connectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!0)}disconnectedCallback(){var t;super.disconnectedCallback(),null===(t=this._$Do)||void 0===t||t.setConnected(!1)}render(){return W}}ht.finalized=!0,ht._$litElement$=!0,null===(ct=globalThis.litElementHydrateSupport)||void 0===ct||ct.call(globalThis,{LitElement:ht});const pt=globalThis.litElementPolyfillSupport;null==pt||pt({LitElement:ht});(null!==(dt=globalThis.litElementVersions)&&void 0!==dt?dt:globalThis.litElementVersions=[]).push("3.3.3");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */null===(ft=window.HTMLSlotElement)||void 0===ft||ft.prototype.assignedElements;var yt,_t;!function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(yt||(yt={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(_t||(_t={}));function bt(t){return t.substr(0,t.indexOf("."))}var $t=["closed","locked","off"],xt=(new Set(["fan","input_boolean","light","switch","group","automation"]),function(t,e,i,n){n=n||{},i=null==i?{}:i;var o=new Event(e,{bubbles:void 0===n.bubbles||n.bubbles,cancelable:Boolean(n.cancelable),composed:void 0===n.composed||n.composed});return o.detail=i,t.dispatchEvent(o),o});new Set(["call-service","divider","section","weblink","cast","select"]);var wt=function(t){xt(window,"haptic",t)},At=function(t,e,i){void 0===i&&(i=!1),i?history.replaceState(null,"",e):history.pushState(null,"",e),xt(window,"location-changed",{replace:i})},Et=function(t,e){return function(t,e,i){void 0===i&&(i=!0);var n,o=bt(e),r="group"===o?"homeassistant":o;switch(o){case"lock":n=i?"unlock":"lock";break;case"cover":n=i?"open_cover":"close_cover";break;default:n=i?"turn_on":"turn_off"}return t.callService(r,n,{entity_id:e})}(t,e,$t.includes(t.states[e].state))},St=function(t,e,i,n){var o;"double_tap"===n&&i.double_tap_action?o=i.double_tap_action:"hold"===n&&i.hold_action?o=i.hold_action:"tap"===n&&i.tap_action&&(o=i.tap_action),function(t,e,i,n){if(n||(n={action:"more-info"}),!n.confirmation||n.confirmation.exemptions&&n.confirmation.exemptions.some(function(t){return t.user===e.user.id})||(wt("warning"),confirm(n.confirmation.text||"Are you sure you want to "+n.action+"?")))switch(n.action){case"more-info":(i.entity||i.camera_image)&&xt(t,"hass-more-info",{entityId:i.entity?i.entity:i.camera_image});break;case"navigate":n.navigation_path&&At(0,n.navigation_path);break;case"url":n.url_path&&window.open(n.url_path);break;case"toggle":i.entity&&(Et(e,i.entity),wt("success"));break;case"call-service":if(!n.service)return void wt("failure");var o=n.service.split(".",2);e.callService(o[0],o[1],n.service_data,n.target),wt("success");break;case"fire-dom-event":xt(t,"ll-custom",n)}}(t,e,i,o)};function kt(t){return void 0!==t&&"none"!==t.action}const Ct=JSON.parse('{"common":{"version":"Version","invalid_configuration":"Ungültige Konfiguration","show_warning":"Warnung anzeigen","configure":"Bitte konfigurieren: Bild-URL und Entitäten mit Koordinaten."}}');var Pt=o.t(Ct,2);const Ot=JSON.parse('{"common":{"version":"Version","invalid_configuration":"Invalid configuration","show_warning":"Show warning","configure":"Please configure: image URL and entities with coordinates."}}');const zt={de:Pt,en:o.t(Ot,2)};function Tt(t,e){return t?.states?.[e]?.attributes?.friendly_name||e}class Ut{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,e,i){this._$Ct=t,this._$AM=e,this._$Ci=i}_$AS(t,e){return this.update(t,e)}update(t,e){return this.render(...e)}}const Nt="ontouchstart"in window||navigator.maxTouchPoints>0;class Mt extends HTMLElement{constructor(){super(...arguments),this.holdTime=500,this.held=!1}connectedCallback(){Object.assign(this.style,{position:"absolute",width:Nt?"100px":"50px",height:Nt?"100px":"50px",transform:"translate(-50%, -50%)",pointerEvents:"none",zIndex:"999"})}bind(t,e){if(t._roomPlanActionHandler)return;t._roomPlanActionHandler=!0,t.addEventListener("contextmenu",t=>(t.preventDefault(),t.stopPropagation(),!1));const i=()=>{this.held=!1,this.timer=window.setTimeout(()=>{this.held=!0},this.holdTime)},n=i=>{if(!["touchend","touchcancel"].includes(i.type)||void 0!==this.timer)if(i.preventDefault(),clearTimeout(this.timer),this.timer=void 0,this.held)xt(t,"action",{action:"hold"});else if(e.hasDoubleClick){const e=i;"click"===i.type&&e.detail<2||!this.dblClickTimeout?this.dblClickTimeout=window.setTimeout(()=>{this.dblClickTimeout=void 0,xt(t,"action",{action:"tap"})},250):(clearTimeout(this.dblClickTimeout),this.dblClickTimeout=void 0,xt(t,"action",{action:"double_tap"}))}else xt(t,"action",{action:"tap"})},o=()=>{clearTimeout(this.timer),this.timer=void 0};["touchcancel","mouseout","mouseup","touchmove","mouseleave"].forEach(e=>{t.addEventListener(e,o,{passive:!0})}),t.addEventListener("touchstart",i,{passive:!0}),t.addEventListener("touchend",n),t.addEventListener("touchcancel",n),t.addEventListener("mousedown",i,{passive:!0}),t.addEventListener("click",n),t.addEventListener("keyup",t=>{"Enter"!==t.key&&13!==t.keyCode||n(t)})}}customElements.define("action-handler-room-plan",Mt);const Ht=(t,e)=>{(()=>{let t=document.body.querySelector("action-handler-room-plan");return t||(t=document.createElement("action-handler-room-plan"),document.body.appendChild(t)),t})().bind(t,e??{})},Rt=(t=>(...e)=>({_$litDirective$:t,values:e}))(class extends Ut{update(t,[e]){return Ht(t.element,e),W}render(t){return W}});var Lt=function(t,e,i,n){var o,r=arguments.length,s=r<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,n);else for(var a=t.length-1;a>=0;a--)(o=t[a])&&(s=(r<3?o(s):r>3?o(e,i,s):o(e,i))||s);return r>3&&s&&Object.defineProperty(e,i,s),s};let jt=class extends ht{constructor(){super(...arguments),this._config={type:"",image:"",entities:[]}}setConfig(t){const e=t??{type:"",image:"",entities:[]},i="string"==typeof e.image?e.image:e.image?.location??"";this._config={...e,image:i,entities:Array.isArray(e.entities)?[...e.entities]:[],entity_filter:Array.isArray(e.entity_filter)?e.entity_filter:void 0}}_emitConfig(){xt(this,"config-changed",{config:this._config})}_updateConfig(t){this._config={...this._config,...t},this._emitConfig()}_updateEntity(t,e){const i=[...this._config.entities??[]];i[t]={...i[t],...e},this._updateConfig({entities:i})}_removeEntity(t){const e=[...this._config.entities??[]];e.splice(t,1),this._updateConfig({entities:e})}_addEntity(){const t=[...this._config.entities??[],{entity:"",x:50,y:50}];this._updateConfig({entities:t})}render(){const t="string"==typeof this._config.image?this._config.image:"",e=this._config.title??"",i=Number(this._config.rotation)??0,n=this._config.entities??[],o=this.hass?.states?Object.keys(this.hass.states).sort():[];return K`
            ...
            ${n.map((t,e)=>K`
              <div class="entity-row">
                ...
                <datalist id="rp-entities-${e}">
                  ${o.slice(0,200).map(t=>K`<option value="${t}">${Tt(this.hass,t)}</option>`)}
                </datalist>
    ...
    `}};Lt([gt({attribute:!1})],jt.prototype,"hass",void 0),Lt([vt()],jt.prototype,"_config",void 0),jt=Lt([ut("room-plan-editor")],jt);var Dt=function(t,e,i,n){var o,r=arguments.length,s=r<3?e:null===n?n=Object.getOwnPropertyDescriptor(e,i):n;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)s=Reflect.decorate(t,e,i,n);else for(var a=t.length-1;a>=0;a--)(o=t[a])&&(s=(r<3?o(s):r>3?o(e,i,s):o(e,i))||s);return r>3&&s&&Object.defineProperty(e,i,s),s};const It="room-plan-card";window.customCards=window.customCards||[],window.customCards.push({type:"custom:"+It,name:"Interaktiver Raumplan",description:"Raumplan als Bild mit Entitäten per Koordinaten (x,y). Kreise mit Icons.",preview:!1});let Bt=class extends ht{constructor(){super(...arguments),this.config={type:"",image:"",entities:[]},this._imageLoaded=!1,this._imageError=!1,this._activeFilter=[]}static async getConfigElement(){return document.createElement("room-plan-editor")}static getStubConfig(){return{image:"/local/raumplan.png",rotation:0,entities:[{entity:"light.example",x:25,y:30,scale:1,color:"#ffc107"},{entity:"sensor.example",x:75,y:40,scale:1}]}}setConfig(t){const e=t?.image&&"string"==typeof t.image?t.image:t?.image?.location??"";this.config={type:t?.type??"custom:room-plan-card",image:e,entities:Array.isArray(t?.entities)?t.entities:[],title:t?.title??"",rotation:Number(t?.rotation)??0,full_height:t?.full_height??!1,tap_action:t?.tap_action,hold_action:t?.hold_action,double_tap_action:t?.double_tap_action,entity_filter:Array.isArray(t?.entity_filter)?t.entity_filter:void 0},this._activeFilter=Array.isArray(t?.entity_filter)?[...t.entity_filter]:[],this._imageLoaded=!1,this._imageError=!1}_getEntityDomain(t){const e=t.indexOf(".");return e>0?t.slice(0,e):""}_filteredEntities(){const t=this.config?.entities??[],e=this._activeFilter.length>0?this._activeFilter:this.config?.entity_filter??[];return e&&0!==e.length?t.filter(t=>e.includes(this._getEntityDomain(t.entity))):t}_availableDomains(){const t=this.config?.entities??[],e=new Set;return t.forEach(t=>{const i=this._getEntityDomain(t.entity);i&&e.add(i)}),Array.from(e).sort()}_toggleFilter(t){const e=this._activeFilter.includes(t)?this._activeFilter.filter(e=>e!==t):[...this._activeFilter,t].sort();this._activeFilter=[...e]}getCardSize(){return this.config?.full_height?1:4}getGridOptions(){return this.config?.full_height?{rows:1,columns:1,min_rows:1,min_columns:1}:{rows:4,columns:6,min_rows:3,min_columns:3}}shouldUpdate(t){return!!this.config&&(!!(t.has("_activeFilter")||t.has("_imageLoaded")||t.has("_imageError"))||function(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var n=e.get("hass");return!n||n.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}(this,t,!1))}connectedCallback(){super.connectedCallback(),this.closest(".element-preview")&&(this.style.display="none")}_getEntityActionConfig(t){const e=this.config?.tap_action??{action:"more-info"};return{entity:t.entity,tap_action:t.tap_action??this.config?.tap_action??e,hold_action:t.hold_action??this.config?.hold_action,double_tap_action:t.double_tap_action??this.config?.double_tap_action}}_handleEntityAction(t,e){const i=this._getEntityActionConfig(e);this.hass&&t.detail?.action&&(St(this,this.hass,i,t.detail.action),wt("light"))}_renderEntity(t){const e=Math.min(100,Math.max(0,Number(t.x)??50)),i=Math.min(100,Math.max(0,Number(t.y)??50)),n=Math.min(2,Math.max(.3,Number(t.scale)??1)),o="on"===this.hass?.states?.[t.entity]?.state,r=t.icon||function(t,e){const i=t?.states?.[e];if(!i)return"mdi:help-circle";if(i.attributes?.icon)return i.attributes.icon;const n=e.split(".")[0],o=i.state;return"light"===n||"switch"===n?"on"===o?"mdi:lightbulb-on":"mdi:lightbulb-outline":"cover"===n?"mdi:blinds":"climate"===n?"mdi:thermostat":"sensor"===n?"mdi:gauge":"binary_sensor"===n?"mdi:motion-sensor":"mdi:circle"}(this.hass,t.entity),s=`${Tt(this.hass,t.entity)}: ${function(t,e){const i=t?.states?.[e];if(!i)return"—";const n=i.attributes?.unit_of_measurement;return n?`${i.state} ${n}`:i.state}(this.hass,t.entity)}`,a=this._getEntityActionConfig(t),l=kt(a.hold_action),c=kt(a.double_tap_action);return K`
      <div
        ...
        tabindex="0"
        role="button"
        .actionHandler=${Rt({hasHold:l,hasDoubleClick:c})}
    ...
    `}_onImageLoad(){this._imageLoaded=!0,this._imageError=!1}_onImageError(){this._imageError=!0,this._imageLoaded=!1}render(){if(this.closest(".element-preview"))return K``;const{image:t,entities:e,title:i,rotation:n}=this.config;if(!t)return K`
        <ha-card>
      ...
      `;const o=this._availableDomains(),r=o.length>0;return K`
      <ha-card class=${this.config?.full_height?"full-height":""}>
        <div class="card-content">
          ...
          <div class="image-wrapper" style="transform: rotate(${n}deg);">
            ...
            />
            ${this._imageLoaded||this._imageError?"":K`<div class="image-skeleton" aria-hidden="true"></div>`}
            ${this._imageError?K`<div class="image-error">Bild konnte nicht geladen werden</div>`:""}
    ...
    `}};Dt([gt({attribute:!1})],Bt.prototype,"hass",void 0),Dt([vt()],Bt.prototype,"config",void 0),Dt([vt()],Bt.prototype,"_imageLoaded",void 0),Dt([vt()],Bt.prototype,"_imageError",void 0),Dt([vt()],Bt.prototype,"_activeFilter",void 0),Bt=Dt([ut(It)],Bt),console.info("%c RAUMPLAN v1.0.0","color: #03a9f4; font-weight: bold");export{Bt as RoomPlanCard};